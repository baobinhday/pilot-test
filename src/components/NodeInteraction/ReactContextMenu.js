...
import listener from 'react-contextmenu/es6/globalEventListener';
import AbstractMenu from 'react-contextmenu/es6/AbstractMenu';
...
export default class ReactContextMenu extends AbstractMenu {
  ...
  handleClickDocument = (e) => {
    // if (e && this.menu && !this.menu.contains(e.target)) {
    //   e.preventDefault();
    //   e.stopPropagation();
    // }
